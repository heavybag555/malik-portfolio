...
export default function LoadingScreen({ onComplete }: LoadingScreenProps) {
  ...
  return (
    <div
      className={`fixed inset-0 z-100 bg-white flex items-center justify-start md:justify-center transition-opacity duration-500 ease-in-out ${
        isFadingOut ? "opacity-0" : "opacity-100"
      }`}
    >
      <div className="w-full max-w-[771px] px-8">
        <div className="flex flex-col items-start md:items-center justify-start md:justify-center gap-0">
          {/* First name */}
          <div className="flex items-center justify-start md:justify-center gap-x-[2px]">
